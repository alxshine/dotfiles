...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; to compile Emacs 27 from source )
   ...
   ;; latest version of packages from MELPA. Spacepa is currently in
...
before packages are loaded."
  ...
  (with-eval-after-load 'org
    ...
    (setq org-todo-keywords
          '((sequence "HOLD" "TODO" "DOING" "|" "DONE" "DELEGATED")))
    )
  )
